...
const projectId = "2Oy70ddlK2qKSjPvvWrr87IcCqr";
const projectSecretKey = "3565d069eaeba8e68edd4e8d7bd675f3";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "https://final-ayush-project.infura-ipfs.io";
